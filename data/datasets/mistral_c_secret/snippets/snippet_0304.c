...
PaymentGatewayConfig* create_payment_gateway_config(const char *gateway_url, const char *public_key) {
...
int main() {
    PaymentGatewayConfig *config = create_payment_gateway_config("https://payment.example.com", "fake_public_key_1234567890");
    if (config == NULL) {
